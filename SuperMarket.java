class SuperMarket{
 ...
 String groceries[] = {"Wheat" , "Ragi" ,"Rice" ,"Urad Dal" ,"Green Grams" ,"Sugar" ,"Salt" , "Cooking oil" , "Jaggery" , "Toor Dal" , "Ghee" ,"Butter" , "Elaichi" , "Dried Fruits" , "Dhania"};
 String vegetables[] = {"Onion" , "Carrot" , "Cauliflower" , "Potato" , "Cabbage" , "Beetroot" , "Cucumber" , " Ladys's Finger" , "Capsium" , "Beans" , " Brinjal" ,"Beans Cluster" , "Sweet Potato" , "Bitter Gourd" , "Green Peas"};
 String perfurms[] = {"Ambre Solaire" , " Armani" , "Fogg" , "Beautify" , "Azzaro" , " Balmain" , "Balgari" , "Fendi", "Esprit" , "Gucci" , "Avedo" , "Wild Stone" , "Ghost" , "Ardell" , "Chanel"};
 ...
 for(String perfurm : perfurms){
	 System.out.println(perfurm);
 }
 ...
 for(String houseHoldProduct : houseHoldProducts){
	 System.out.println(houseHoldProduct);
 }
 ...
 for(String fashionn : fashion){
	 System.out.println(fashionn);
 }
...
for(String alcoholl : alcohol){
	 System.out.println(alcoholl);
 }
